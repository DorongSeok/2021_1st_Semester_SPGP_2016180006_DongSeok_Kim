...
> <img src="./image/pikaman1.png" width="800px" height="256px" title="PikaMan" alt="PikaMan"></img><br/>    
> 동작 구성    
> 가로 방향 중심을 기준으로 화면을 2개로 나눠 터치하는 부분에서 공격한다.
>    
> * Enemy   
> 그림 구성 : 플레이어를 방해하는 지느러미가 좌, 우, 무 3가지 종류가 있다.    
> <img src="./image/enemy.png" width="816px" height="80px" title="Enemy" alt="Enemy"></img><br/>   
> 동작 구성   
...
> * Background   
> 그림 구성 : 낮과 밤을 표현     
> <img src="./image/poke_bg.png" width="99px" height="800px" title="poke_bg" alt="poke_bg"></img><br/>    
> 동작 구성    
> 서서히 아래로 이동한다.   
> 낮과 밤이 바뀌는 효과를 준다
- - -
